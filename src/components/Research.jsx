      ...
      <div className="container">
        <div className="section-header">
          ...
          <p className="section-subtitle">
            Advancing low-resource Natural Language Processing, computer vision deepfake detection, and curated agricultural benchmark datasets.
          </p>
        </div>
          ...
          {researchItems.map((item) => (
            ...
            >
              <div>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.85rem', flexWrap: 'wrap' }}>
                  <span
                    style={{
                      ...
                      background: item.badge?.includes('Published') ? 'rgba(16, 185, 129, 0.12)' : 'rgba(37, 99, 235, 0.12)',
                ...
                {/* Title */}
                <h3 style={{ fontSize: 'clamp(1.2rem, 2.5vw, 1.45rem)', marginBottom: '0.65rem', color: 'var(--text-main)' }}>
                  {item.title}
                </h3>

                {/* Key Metric Highlight */}
                {item.keyMetric && (
                  <div style={{ fontSize: '0.85rem', color: 'var(--cyan)', marginBottom: '0.85rem', fontFamily: 'var(--font-mono)', fontWeight: 600 }}>
                    ⚡ {item.keyMetric}
                  </div>
                )}
              ...
              {/* Action Column */}
              <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: '0.75rem' }} className="research-action-col">
                <button
                  type="button"
